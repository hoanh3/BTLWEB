        ...
        <div class="slider">
            ...
            <div class="slider-wrapper">
                <picture>
                    ...
                    <img src="${url}/images/Slider/slide_index_1.png" alt="slider" class="slider__img" draggable="false">
                </picture>
                <picture>
                    <source media="(max-width: 739px)" srcset="${url}/images/Slider/slide_index_2_mb.png">
                    <img src="${url}/images/Slider/slide_index_2.png" alt="slider" class="slider__img" draggable="false">
                </picture>
                <picture>
                    <source media="(max-width: 739px)" srcset="${url}/images/Slider/slide_index_1_mb.png">
                    <img src="${url}/images/Slider/slide_index_1.png" alt="slider" class="slider__img" draggable="false">
                            ...
                            <div class="col l-4 m-4 c-6">
                                <div class="box-favorite">
                                    <a href="#" class="favorite-link">
                                        <img src="${url}/images/Favorites/banner_index_1.png" alt="" class="favorite-img">
                                    </a>
                                </div>
                            </div>
                            <div class="col l-4 m-4 c-6">
                                <div class="box-favorite">
                                    <a href="#" class="favorite-link">
                                        <img src="${url}/images/Favorites/banner_index_2.png" alt="" class="favorite-img">
                                    </a>
                                </div>
                            </div>
                            <div class="col l-4 m-4 c-6">
                                <div class="box-favorite">
                                    <a href="#" class="favorite-link">
                                        <img src="${url}/images/Favorites/banner_index_3.png" alt="" class="favorite-img">
                                    </a>
                                </div>
                            </div>
                            <div class="col l-4 m-4 c-6">
                                <div class="box-favorite">
                                    <a href="#" class="favorite-link">
                                        <img src="${url}/images/Favorites/banner_index_4.png" alt="" class="favorite-img">
                                    </a>
                                </div>
                            </div>
                            <div class="col l-4 m-4 c-6">
                                <div class="box-favorite">
                                    <a href="#" class="favorite-link">
                                        <img src="${url}/images/Favorites/banner_index_5.png" alt="" class="favorite-img">
                                    </a>
                                </div>
                            </div>
                            <div class="col l-4 m-4 c-6">
                                <div class="box-favorite">
                                    <a href="#" class="favorite-link">
                                        <img src="${url}/images/Favorites/banner_index_6.png" alt="" class="favorite-img">
                                    </a>
                                </div>
                            </div>
                        </div>
